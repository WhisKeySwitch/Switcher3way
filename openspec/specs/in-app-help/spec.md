...
Gives users the full user manual inside the app, offline, in their interface language. The bundled help is generated from the repository manuals at build time so documentation and in-app help can never drift apart.
