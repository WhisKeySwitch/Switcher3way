...
- [x] 7.1 Build signed app; verify menu item, settings toggle, and localized strings render
...
- [x] 7.4 Verify skip-version persistence, Later behavior, background-failure silence (network off), and `openspec validate --specs`
